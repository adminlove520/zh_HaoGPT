      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          {/* <DrawerItem
            icon={<FaDiscord />}
            text="Discord"
            href="https://discord.gg/ewYWt9DF"
            target="_blank"
          />
          <DrawerItem
            icon={<FaSlack />}
            text="Slack"
            href="https://join.slack.com/t/hopesoft-hq/shared_invite/zt-1t5rns5qt-b4O6Wf1~9UOTla~nSkxpUg"
            target="_blank"
          />
          <DrawerItem
            icon={<FaGithub />}
            text="GitHub"
            href="https://github.com/adminlove520/HaoGPT"
            target="_blank"
          /> */}
        </div>
      </div>
